...
export const metadata: Metadata = {
  title: "Signin - Loan App",
  description: "This is Signin page for Mini Loan App",
  // other metadata
};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isValid) {
      ...
      try {
        ...
        if (response.ok) {
          // Login successful, you can perform actions such as redirecting to a dashboard page
          ...
          setErr(data.error);
          // You can update the state to display an error message to the user
            ...
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <h2 className="text-black dark:text-white text-4xl font-bold">
                  Mini Loan App Creditsea
                </h2>
              </Link>

              <p className="2xl:px-20">
                Welcome to Our Website! Please sign in to take the loan.
              </p>
