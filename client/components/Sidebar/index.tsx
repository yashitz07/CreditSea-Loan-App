      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          {/* <Image
            ...
            alt="Logo"
          /> */}
          <h2 className="text-white text-4xl font-bold">Credit App</h2>
        </Link>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <SidebarLinkGroup
                  activeCondition={
                    ...
                    pathname.includes("manage-loans")
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                href="/manage-loans/request-loan"
                                className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/manage-loans/request-loan" &&
                                  "text-white"
                                }`}
                              >
                                Request Loan
                            ...
                            <li>
                              <Link
                                href="/manage-loans/my-loans"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/manage-loans/my-loans" &&
                                  "text-white"
                                }`}
                              >
                                My Loans
